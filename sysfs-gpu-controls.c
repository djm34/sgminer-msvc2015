...
int sysfs_gpu_engineclock(int gpu) { return 0; }
int sysfs_gpu_memclock(int gpu) { return 0; }
float sysfs_gpu_vddc(int gpu) { return 0; }
int sysfs_gpu_activity(int gpu) { return 0; }
int sysfs_gpu_fanspeed(int gpu) { return(-1); }

int sysfs_set_vddc(int gpu, float fVddc) { return 0; }
int sysfs_set_engineclock(int gpu, int iEngineClock) { return 0; }
int sysfs_set_memoryclock(int gpu, int iMemoryClock) { return 0; }
int sysfs_set_powertune(int gpu, int iPercentage) { return 0; }
