...
void LightEthash(uint8_t *__restrict OutHash, uint8_t *__restrict MixHash, const uint8_t *__restrict HeaderPoWHash, const Node *Cache, const uint64_t EpochNumber, const uint64_t Nonce)
{
